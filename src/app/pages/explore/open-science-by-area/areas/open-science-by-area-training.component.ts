...
export class OpenScienceByAreaTrainingComponent implements OnInit {
  ...
  policyTabConfig: AreaMapTabConfig = {
    question: 'Question42',
    title: 'National policy on Open Science Training',
    caption: policesMapCaptions[9] + '<strong>Data source:</strong> Survey on National Contributions to EOSC and Open Science ' + this.year + '.',
    labelSuffix: ' countries have a <br>national policy on Open Science Training</span>'
  };

  monitoringTabConfig: AreaMapTabConfig = {
    question: 'Question90',
    title: 'National monitoring on Open Science Training',
    caption: monitoringMapCaptions[9] + '<strong>Data source:</strong> Survey on National Contributions to EOSC and Open Science ' + this.year + '.',
    labelSuffix: ' countries have a <br>national monitoring on Open Science Training</span>'
  };

  financialStrategyTabConfig: AreaMapTabConfig = {
    question: 'Question43',
    title: 'National financial strategy on Open Science Training',
    caption: '<p>This map illustrates the status of national financial strategies on Open Science Training across European countries.</p><strong>Data source:</strong> Survey on National Contributions to EOSC and Open Science ' + this.year + '.',
    labelSuffix: ' countries have a <br>national financial strategy on Open Science Training</span>'
  };

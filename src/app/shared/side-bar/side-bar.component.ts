...
export class MenuItem {
  ...
  constructor(id: string, title: string, route: string, routeActive: string, icon: string | null = null,
...
export class SideBarComponent implements OnInit, AfterViewInit, OnDestroy, OnChanges {
  ...
  constructor(private route: ActivatedRoute, private router: Router, private layoutService: SideBarService,
